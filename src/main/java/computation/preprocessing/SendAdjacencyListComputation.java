...
public class SendAdjacencyListComputation extends AbstractComputation<IntWritable,
    ...
    public void preSuperstep() {
        stepsToDo = ((IntWritable) getAggregatedValue(WccMasterCompute.NUMBER_OF_PREPROCESSING_STEPS)).get();
        ...
        if (finished) {
            ...
            aggregate(WccMasterCompute.NEXT_PHASE, new IntWritable(WccMasterCompute.FINISH_PREPROCESSING));
        }
    }
